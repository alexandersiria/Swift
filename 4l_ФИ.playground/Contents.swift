...
var user1 = ProfileForJobSearching(name: "Alena", gender: .female, birthDay: .init(day: 22, mounth: 3, year: 1994), education: "Oxford", speciality: "Technology development and maintenance of the software product", experience: "Mobile app developer: 'Note+', 'Quip'")
user1.printInfo()
user1.addExperience(newExperience: "Mobile iOS developer at Company Name")
user1.printInfo()

var user2 = ProfileAboutMe(name: "Alex", gender: .male, birthDay: .init(day: 5, mounth: 1, year: 1998), hobbie: "Skateboarding", myFavoriteBook: "'Сrime and punishment' F.M.Dostoevsky", myFavoriteFilm: "Blade Runner 2049", myFavoriteMusic: "Alternative", myFavoriteFood: "Sushi")
user2.printInfo()
